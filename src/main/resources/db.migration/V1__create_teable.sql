...
INSERT INTO products(article, body_shape, color, discount, file, gender, memory, name, operating_system, price,
                     processor, rating, release_date, screen, sim_card, warranty, water_resistance, weight,
                     wireless_interface, brand_id)
VALUES ('0214', 'квадрат', 'black', '15', null, 'FEMALE', '125Gb', 'iphone 12', 'IOS', '95000', 'A15 Bionic', '5',
...
INSERT INTO orders(address, created, payment, photo, status, sum, update, bucked_id, user_id)
...
INSERT INTO reviews_to_response_reviews(reviews_id, response_reviews_id)
VALUES (2, 1);
